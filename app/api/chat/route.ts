  ...
  const modeSection =
    mode === "ask"
      ...
      : [
          ...
          "- Each edit is shown to the user as a diff they can accept, refine, or reject, so keep edits focused and explain your reasoning briefly in the tool's 'reason'.",
          "- If the user asks to refine a pending suggestion, that original diff has been discarded and was NOT applied. Incorporate their feedback into one replacement tool call for the same passage, using the CURRENT DOCUMENT as the source of truth, then stop for review.",
